...
const CustomizeProducts = () => {
    return (
        <div className="flex flex-col gap-6 ">
            ...
            <ul className="flex items-center gap-3">
                <li className="ring-1 ring-alertMsg text-alertMsg rounded-md py-1 px-4 text-sm cursor-pointer">
                    Small
                </li>
                <li className="ring-1 ring-alertMsg text-white bg-alertMsg rounded-md py-1 px-4 text-sm cursor-pointer">Medium</li>
